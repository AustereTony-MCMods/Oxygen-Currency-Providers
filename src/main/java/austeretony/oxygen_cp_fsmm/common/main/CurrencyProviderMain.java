...
import austeretony.oxygen_cp_fsmm.client.currency.FSMMCurrencyProperties;
...
@Mod(
        ...
        dependencies = "required-after:oxygen_core@[0.11.0,);required-after:fsmm@[2.3.0,);",
...
public class CurrencyProviderMain {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        if (event.getSide() == Side.CLIENT)
            OxygenHelperClient.registerCurrencyProperties(new FSMMCurrencyProperties());
    }
}
