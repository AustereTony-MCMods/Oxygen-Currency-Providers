package austeretony.oxygen_cp_fsmm.common.config;
...
import austeretony.oxygen_cp_fsmm.common.main.CurrencyProviderMain;
...
public class CurrencyProviderConfig extends AbstractConfig {
    ...
    public String getExternalPath() {
        return CommonReference.getGameFolder() + "/config/oxygen/currency providers/fsmm.json";
    }
