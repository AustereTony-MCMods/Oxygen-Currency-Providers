package austeretony.oxygen_cp_ftb.common.main;

import austeretony.oxygen_core.client.api.OxygenHelperClient;
import austeretony.oxygen_core.common.api.OxygenHelperCommon;
import austeretony.oxygen_core.server.api.CurrencyHelperServer;
import austeretony.oxygen_cp_ftb.client.currency.FTBCurrencyProperties;
import austeretony.oxygen_cp_ftb.common.config.CurrencyProviderConfig;
import austeretony.oxygen_cp_ftb.server.currency.FTBCurrencyProvider;
...
public class CurrencyProviderMain {
    ...
    public void init(FMLInitializationEvent event) {
        CurrencyHelperServer.registerCurrencyProvider(new FTBCurrencyProvider());
        if (event.getSide() == Side.CLIENT)
            OxygenHelperClient.registerCurrencyProperties(new FTBCurrencyProperties());
    }
}
